...
import com.proper.bin2bin.ActBinMoveMonitor;
...
public class
    ...
    private UserLoginResponse currentUser = new UserLoginResponse();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyt_binmain);
                    ...
                    if (getScanInput().length() == 5) {
                        ...
                        switch (NAV_TURN) {
                            case R.integer.TURN_DESTINATION:
                                ...
                                if (!txtDestinationReception.getText().toString().equalsIgnoreCase("")) {
                                    //setDestinationInput(buff);
                                    txtDestinationReception.setText("");
                                    txtDestinationReception.setText(getScanInput()); //don't know we can reach this code....
                            ...
                            case R.integer.TURN_SOURCE:
                                ...
                                if (!txtSourceReception.getText().toString().equalsIgnoreCase("")) {
                                    ...
                                    txtSourceReception.setText(getScanInput()); //don't know we can reach this code....
                        ...
                        switch (NAV_TURN) {
                            case R.integer.TURN_DESTINATION:
                                ...
                                txtDestinationReception.setText("");
                                btnScanDestination.setEnabled(true);
                                //btnScanDestination.setText("");     //>>>>>>>>>>>>>>>>>>>>>>>> new entry <<<<<<<<<<<<<<<<<<<<<<<
            ...
            case R.integer.TURN_DESTINATION:
                ...
                if (inputByHand == 0) {
                    ...
                    if (!getScanInput().isEmpty()) {
                        ...
                        paintByHandButtons();
                        //txtSourceReception.requestFocus(); removed-----------------------------
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.bnContinue:
                    //check if we already have both (src & dest) values
//                    if (btnScanSource.isEnabled() == false && btnScanDestination.isEnabled() == false) {
//                    }
...
//                if (txtDestinationReception.isEnabled() == true && btnScanDestination.isEnabled() == true) {
//                    if (txtSourceReception.isEnabled() == true && btnScanSource.isEnabled() == true) {
//                        btnScanSource.performClick();
//                    }
//                }
//                if (txtSourceReception.isEnabled() == false && !txtSourceReception.getText().toString().trim().equalsIgnoreCase("")
//                        && btnScanSource.isEnabled() == false) {
//                    btnScanDestination.performClick();
//                }
                break;
            case KEY_F1:
                ...
                if (currentSourceBin != null && !currentSourceBin.equalsIgnoreCase("") &&
                    ...
                    switch (NAV_INSTRUCTION) {
                        case R.integer.ACTION_PARTIALMOVE:
                            Intent i = new Intent(com.android.barcode.ActBinMain.this, com.proper.bin2bin.ActBinItemSelection.class);
                            ...
                            startActivityForResult(i, R.integer.ACTION_BINMOVE);
                            break;
                        case R.integer.ACTION_BINMOVE:
                            Intent i2 = new Intent(com.android.barcode.ActBinMain.this, com.proper.bin2bin.ActBinDetails.class);
                            ...
                            startActivityForResult(i2, R.integer.ACTION_BINMOVE);
                            break;
                    }
                }
            } else {
