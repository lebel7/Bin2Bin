...
import com.proper.bin2bin.ActSingleDetails;
 ...
 */
public class fgmSingleItemDetails extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View myView = inflater.inflate(R.layout.lyt_fgmsingleitemdetails, container, false);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        try {
            ...
            LogEntry log = new LogEntry(1L, ApplicationID, "fgmSingleItemDetails - onContextItemSelected", deviceIMEI, ex.getClass().getSimpleName(), ex.getMessage(), today);
            logger.Log(log);
        }
        return true;
    }
