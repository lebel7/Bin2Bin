...
import com.proper.fragments.ProductDetailsDialogFragment;
...
/**
 * Created by Lebel on 17/06/2014.
 */
public class ActBinItemSelection extends FragmentActivity implements ICommunicator {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lyt_binitem_selection);
        ...
        try {
            ...
            lvProducts.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScrollStateChanged(AbsListView view, int scrollState) {
                    onListScrolled(view, scrollState);
                }
    ...
    private void onListScrolled(AbsListView view, int scrollState) {
//        lvProducts.setFocusable(true);
//        lvProducts.setSelectionAfterHeaderView();
        lvProducts.setSelection(view.getFirstVisiblePosition());
    }
