...
public class BinResponseSelectionAdapter extends BaseAdapter implements IOnItemSelectionChanged {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        int currentPos = i;
        thisView = view;
        //ViewHolder holder = new ViewHolder(); move to the outer scope
        ViewHolder holder = new ViewHolder();
        if (thisView == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            thisView = inflater.inflate(R.layout.list_binselection_item, viewGroup, false);
...
//                }
    ...
    public static class ViewHolder {
        public TextView binQty;
        public TextView suppCat;
        public TextView moveQty;
